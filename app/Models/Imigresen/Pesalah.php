...
class Pesalah extends Model {
    ...
    public static function getPesalahPassport($passport_no){
        $query = "select 
            ...
            k.no_passport,
            k.warganegara,
            to_char(f.epd,'dd-mm-yyyy') as tarikh_bebas,
            to_char(f.tarikh_mula_huk,'dd-mm-yyyy') as tarikh_mula_hukuman, 
            to_char(f.epd,'dd-mm-yyyy') as tarikh_bebas_awal,
            to_char(f.lpd,'dd-mm-yyyy') as tarikh_bebas_lewat,
            a.nama_waris,
            a.no_tel_waris,
            a.alamat_1_waris,
            c.jenis_harta,
    ...
    public static function getPesalahSmppNo($smpp_no){
        $query = "select f.nama_pesalah,g.nama_penjara, date_part('year',age(current_date,b.tarikh_lahir))as umur,b.jantina,b.agama,b.bangsa,f.no_smpp,b.no_passport,
        b.warganegara,
        to_char(f.epd,'dd-mm-yyyy') as tarikh_bebas_awal,
        to_char(f.lpd,'dd-mm-yyyy') as tarikh_bebas_lewat,
        to_char(f.tarikh_mula_huk,'dd-mm-yyyy') as Tarikh_mula_hukuman,
        a.nama_waris,a.no_tel_waris,a.alamat_1_waris,c.jenis_harta,c.keterangan as keterangan_harta, c.kategori_harta, d.waran_id, d.no_waran,e.akta,e.seksyen,e.keterangan_hukuman,
