...
class SejarahLampauController extends Controller {
    ...
    public function getSejarahLampau(Request $request){
    ...
    public function withHpmkFormat($data){
        ...
        if($request->status == 'success'){
            ...
            if(!$valid_ic){
                ...
                // $pesalah    = env('MOCK_DATA') ? $this->mockHadirProgram() : Maklumat::getSejarahLampau($nric);
                $pesalah    = Maklumat::getSejarahLampau($nric);
                $data->hpmk_message->hpmk_message_payload = (Object) array();
